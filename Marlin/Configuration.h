...
#define STRING_CONFIG_H_AUTHOR "Marc Liebig" // Who made the changes.
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 60 // Extended max to allow the probe to reach more of the bed.
#define Y_MAX_POS Y_BED_SIZE + 10  // Extended max to allow the probe to reach more of the bed.
