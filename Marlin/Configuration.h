...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 245 // Extended max to allow the probe to reach more of the bed.
#define Y_MAX_POS 230  // Extended max to allow the probe to reach more of the bed.
