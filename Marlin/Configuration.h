...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 40 // Extended max to allow the probe to reach more of the bed.
#define Y_MAX_POS Y_BED_SIZE + 4  // Extended max to allow the probe to reach more of the bed.
